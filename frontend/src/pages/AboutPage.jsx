    ...
    <div className="space-y-12 pb-20 text-left max-w-4xl mx-auto">
      <div className="text-center space-y-4 pt-6">
        <span className="text-xs px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 font-extrabold border border-blue-200 dark:border-blue-500/20 font-mono uppercase">
          SkillBridge Platform Mission Statement
        </span>
      ...
      <div className="sb-glass-card p-8 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-6">
        ...
        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          Traditional college placement platforms rely on generic resumes that hide true engineering competencies. SkillBridge introduces a multi-dimensional Skill DNA matrix that evaluates student codebase depth, algorithmic capability, and core domain knowledge.
        </p>
        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          By bridging static academic syllabi with live enterprise requirements through the **Academia × Industry Lab**, SkillBridge helps educational institutions deliver industry-ready engineering graduates.
        </p>
      </div>
