...
export function Button({
  ...
  const variants = {
    primary: "bg-indigo-600 hover:bg-indigo-500 text-white shadow-sm shadow-indigo-600/20 active:bg-indigo-700",
    ...
    violet: "bg-indigo-600 hover:bg-indigo-500 text-white shadow-sm shadow-indigo-600/20 active:bg-indigo-700",
    outline: "bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800/80 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 hover:text-indigo-600 dark:hover:text-white",
